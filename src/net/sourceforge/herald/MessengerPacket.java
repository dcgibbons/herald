/*
 * $Id: MessengerPacket.java,v 1.3 2000/06/12 04:58:18 dcgibbons Exp $
 *
...
public class MessengerPacket {
     ...
     */
    public static MessengerPacket getInstance(String rawPacket) 
        ...
        /* locate the packet class type based on the command text */
...
/*
        commands.put(MessengerProtocol.CMD_ADD, "MessageAddPacket");
*/
...
/*
        commands.put(MessengerProtocol.CMD_REM, "MessageRemCommand");
*/
